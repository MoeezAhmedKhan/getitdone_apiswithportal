...
if($_POST['token'] == 'as23rlkjadsnlkcj23qkjnfsDKJcnzdfb3353ads54vd3favaeveavgbqaerbVEWDSC')
{
    ...
    $insert_task = "INSERT INTO `task`(`user_id`, `dropoff_location`, `latitude`, `longitude`) VALUES ('$u_id','$drop','$drop_lat','$drop_lon')";
    ...
    foreach($data as $item)
    {
        ...
        $pick_lon =  $item->pick_lon;
    
        //   print_r($menu_item_id);
       
        $insert = "INSERT INTO `task_details`(`task_id`, `title`, `name`, `description`, `estimated_cost`,
        `pickup_location`,`menu_item_id`,`latitude`, `longitude`) 
        VALUES ('$last_id','$title','$name','$desc','$estimate_amount','$pickup_location','$menu_item_id','$pick_lat','$pick_lon')";
