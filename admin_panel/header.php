        ...
        <div class="page">
			...
			<div class="app-header header sticky">
                <div class="container-fluid main-container">
                    <div class="d-flex">
                        <a aria-label="Hide Sidebar" data-bs-toggle="sidebar" href="javascript:void(0)">
                             &nbsp;&nbsp;
                        ...
                        <a href="index.php" class="logo-name" style="position:relative;left:120px">
                            <!--<img src="assets/images/brand/logo.png" class="header-brand-img desktop-logo" alt="logo">-->
                            <!--<img src="assets/images/brand/logo-3.png" class="header-brand-img light-logo1"-->
                            <!--    alt="logo">-->
                            <h1 class="header-brand-img light-logo1 mylogo" style="margin-left:-35px;font-weight: bold;">Get It Done</h1>
                        </a>
                            ...
                            <div class="navbar navbar-collapse responsive-navbar p-0">
                                <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                                    <div class="d-flex order-lg-2 mybox">
                                        ...
                                        <!--</div>-->
                                        <!-- CART -->
                                        <div class="dropdown d-flex" style="background:color:red">
                                        ...
                                        <div class="dropdown d-flex profile-1">
                                            <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link leading-none d-flex">
                                                ...
                                                <!--    class="avatar  profile-user brround cover-image">-->
                                                    <i class="fa fa-user avatar  profile-user brround cover-image" style="font-size:19px" aria-hidden="true"></i>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                <div class="drop-heading">
                                                    ...
                                                    <?php
                                                            ...
                                                            if(isset($_SESSION["role"]) && $_SESSION["role"] == '0' || $_SESSION["role"] == '3')
                                                            {
                                                                ?>
                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="index.php">
                            ...
                            <h2 class="header-brand-img desktop-logo" style="margin-left:-12px;font-weight: bold;color:white"> Get It Done</h2>
                            <h6 class="header-brand-img toggle-logo" style="margin-left:-35px;font-weight: bold;">Get It Done</h6>
                            <h6 class="header-brand-img light-logo" style="margin-left:-12px;font-weight: bold;"> Get It Done</h6>
                            <h2 class="header-brand-img light-logo1" style="margin-left:-35px;font-weight: bold;">Get It Done</h2>
                        </a>
                        <!-- LOGO -->
                    </div>
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item has-link" data-bs-toggle="slide" href="index.php"><i class="side-menu__icon fa fa-home"></i><span class="side-menu__label">Analytics</span></a>
                            </li>
                            ...
                            <?php 
                                ...
                                if(isset($_SESSION["role"]) && $_SESSION["role"] == '0')
                                {
                                    ?>
                                    <li class="slide">
                                        <a class="side-menu__item" href="add_sub_admin.php"><i class="side-menu__icon fas fa-user-plus"></i><span class="side-menu__label">Add Sub Admin</span></a>
                                    </li>
                                    <?php
                                }
                            ...
                            <li class="slide">
                                <a class="side-menu__item" href="add_provider.php"><i class="side-menu__icon fa fa-user"></i><span class="side-menu__label">Add Provider</span></a>
                            </li>
                            
                            <li class="slide">
                                <a class="side-menu__item" href="add_work_category.php"><i class="side-menu__icon fa fa-tasks"></i><span class="side-menu__label">Add Work Category</span></a>
                            </li>
                            
                            <li class="slide">
                                <a class="side-menu__item" href="add_bank.php"><i class="side-menu__icon fa fa-bank"></i><span class="side-menu__label">Add Bank</span></a>
                            </li>
                            ...
                            <li class="slide">
                                <a class="side-menu__item" href="manage_provider.php"><i class="side-menu__icon fa-solid fa-pen-to-square"></i><span class="side-menu__label">Manage Provider</span></a>
                            </li>
         
                            <li class="slide">
                                <a class="side-menu__item" href="manage_customer.php"><i class="side-menu__icon fa-solid fa-pen-to-square"></i><span class="side-menu__label">Manage Customer</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" href="manage_task.php"><i class="side-menu__icon fa-solid fa-pen-to-square"></i><span class="side-menu__label">Manage Tasks</span></a>
                            </li>
                            <li class="slide">
                                <a class="side-menu__item" href="manage_work_category.php"><i class="side-menu__icon fa-solid fa-pen-to-square"></i><span class="side-menu__label">Manage Work Category</span></a>
                            </li>
                            
                            <li class="slide">
                                <a class="side-menu__item" href="manage_bank.php"><i class="side-menu__icon fa-solid fa-pen-to-square"></i><span class="side-menu__label">Manage Banks</span></a>
                            </li>
                            
                            <li class="slide">
                                <a class="side-menu__item" href="manage_rider_share.php"><i class="side-menu__icon fa-solid fa-pen-to-square"></i><span class="side-menu__label">Rider Share</span></a>
                            </li>
                             ...
                             <?php 
                                ...
                                if(isset($_SESSION["role"]) && $_SESSION["role"] == '0')
                                {
                                    ?>
                                    <li class="slide">
                                        <a class="side-menu__item" href="manage_sub_admin.php"><i class="side-menu__icon fa-solid fa-pen-to-square"></i><span class="side-menu__label">Manage Sub Admin</span></a>
                                    </li>
                                    <?php
                                }
