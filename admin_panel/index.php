                ...
                <div class="main-content app-content mt-0">
                    <div class="side-app">
                        ...
                        <div class="main-container container-fluid">
                            ...
                            <!-- ROW-1 -->
                                ...
                                <?php
                                    ...
                                    if(isset($_SESSION["role"]) && $_SESSION["role"] == '0')
                                    {
                                        ...
                                        <h2 class="side-menu__icon page-title">Sub Admin</h2>
                                            ...
                                            <div class="card overflow-hidden">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Sub Admin</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `users` where role_id = '3' and status = 'active'";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                       ...
                                                       <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Active Staff</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `users` where role_id = '3' and status = 'suspended'";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Suspended Staff</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1">
                                ...
                                <!--sub admin end-->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4 col-xxl-4">
                                            <div class="card overflow-hidden">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <?php
                                                        ...
                                                        ?>
                                                         <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Users</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `users` where status = 'active' and role_id != 0";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Active Users</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `users` where status = 'suspended' and role_id != 0";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Suspended Users</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        ?>
                                                         <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Customers</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `users` where role_id = '1' and status = 'active'";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Active Customers</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `users` where role_id = '1' and status = 'suspended'";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Suspended Customers</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        ?>
                                                         <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Riders</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                            ...
                                            <div class="card overflow-hidden">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Active Riders</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <?php
                                                            ...
                                                            require_once("connection.php");
                                                            $sql = "SELECT * FROM `users` where role_id = '2' and status = 'suspended'";
                                                            $run = mysqli_query($conn,$sql);
                                                            $num = mysqli_num_rows($run);
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Suspended Riders</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        ?>
                                                         <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Tasks</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4 col-xxl-4">
                                            <h2 class="page-title">Tasks Pending</h2>
                                            <div class="card overflow-hidden">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <?php
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Pending Tasks</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                           ...
                                           <div class="col-lg-4 col-md-4 col-sm-4 col-xl-4 col-xxl-4">
                                              <h2 class="page-title">Tasks Completed</h2>
                                            <div class="card overflow-hidden">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <?php
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Completed Tasks</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                    ...
                                    <div class="row">  
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xl-6 col-xxl-6">
                                            <h2 class="page-title">Work Categories</h2>
                                            <div class="card overflow-hidden">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <?php
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Work Categories</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                                                            <div class="chart-wrapper mt-1"><canvas id="leadschart" class="h-8 w-9 chart-dropshadow"></canvas>
                                            ...
                                            <div class="card overflow-hidden">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="mt-2">
                                                            <h2 class="mb-0 number-font mb-2"><?php echo $num ?></h2>
                                                            <p class="font-medium-2">Total Banks</p>
                                                            <span style="font-size:18px">Till Now</span>
                                                        </div>
                                                        <div class="ms-auto">
                            ...
                            <!--                </div>-->
                            <!--                <div class="chartjs-wrapper-demo"> <canvas id="transactions" class="chart-dropshadow"></canvas>-->
                            <!--                </div>-->
                            <!--            </div>-->
                            <!--        </div>-->
                            <!--    </div>-->
                            ...
                            <!--                            <h6 class="fw-semibold">New Comment<span class="text-muted fs-11 mx-2 fw-normal">25 June 2021</span>-->
                            <!--                            </h6>-->
                            <!--                            <p class="text-muted fs-12">Victoria commented on Project <a href="javascript:void(0)" class="fw-semibold"> AngularJS Template</a></p>-->
                            <!--                        </div>-->
                            <!--                        <div class="ms-auto d-md-flex">-->
                            ...
                            <!--                            <h6 class="fw-semibold">Task Overdue<span class="text-muted fs-11 mx-2 fw-normal">14 June 2021</span>-->
                            <!--                            </h6>-->
                            <!--                            <p class="text-muted fs-12">Petey Cruiser finished task <a href="javascript:void(0)" class="fw-semibold"> Integrated management</a></p>-->
                            <!--                        </div>-->
                            <!--                        <div class="ms-auto d-md-flex">-->
                            <!--                            <a href="javascript:void(0)" class="text-muted me-2" data-bs-toggle="tooltip"-->
                            ...
                            <!--                                            height="18" fill="currentColor" class="bibi-phone" viewBox="0 0 16 16">-->
                            <!--                                            <path-->
                            ...
                            <!--                                        xmlns="http://www.w3.org/2000/svg" width="18"-->
                            <!--                                        height="18" fill="currentColor" class="bi bi-display" viewBox="0 0 16 16">-->
                            ...
                            <!--                                            xmlns="http://www.w3.org/2000/svg" width="18"-->
                            <!--                                            height="18" fill="currentColor" class="bi bi-tablet" viewBox="0 0 16 16">-->
                            <!--                                            <path-->
                            ...
                            <!--                                <h6 class="fw-semibold mb-1">35,502 <span class="text-success fs-11">(<i class="fe fe-arrow-up"></i>12.75%)</span></h6>-->
                            <!--                            </div>-->
                            ...
                            <!--                                <h6 class="fw-semibold mb-1">12,563 <span class="text-danger fs-11">(<i class="fe fe-arrow-down"></i>15.12%)</span></h6>-->
                            <!--                            </div>-->
                            <!--                            <div class="progress h-2 mb-3">-->
                            ...
                            <!--                            <div class="d-flex align-items-end justify-content-between mb-1">-->
                            <!--                                <h6 class="mb-1">IE</h6>-->
                            <!--                                <h6 class="fw-semibold mb-1">25,364 <span class="text-success fs-11">(<i class="fe fe-arrow-down"></i>24.37%)</span></h6>-->
                            <!--                            </div>-->
                            <!--                            <div class="progress h-2 mb-3">-->
                            ...
                            <!--                                <h6 class="fw-semibold mb-1">14,635 <span class="text-success fs-11">(<i class="fe fe-arrow-down"></i>15.63%)</span></h6>-->
                            <!--                            </div>-->
                            <!--                            <div class="progress h-2 mb-3">-->
                            ...
                            <!--                                <h6 class="fw-semibold mb-1">15,453 <span class="text-danger fs-11">(<i class="fe fe-arrow-down"></i>23.70%)</span></h6>-->
                            <!--                            </div>-->
                            <!--                            <div class="progress h-2 mb-3">-->
                            ...
                            <!--                                <h6 class="fw-semibold mb-1">10,054 <span class="text-success fs-11">(<i class="fe fe-arrow-up"></i>11.04%)</span></h6>-->
                            <!--                            </div>-->
                            <!--                            <div class="progress h-2 mb-3">-->
